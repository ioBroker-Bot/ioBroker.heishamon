...
export function getBit1(frame: Uint8Array, offset: number): number {
  return frame[offset]! >> 7;
}

/** Top two bits, minus 1. */
export function getBit1and2(frame: Uint8Array, offset: number): number {
  return (frame[offset]! >> 6) - 1;
}

/** Bits 3 and 4 (counting from MSB), minus 1. */
export function getBit3and4(frame: Uint8Array, offset: number): number {
  return ((frame[offset]! >> 4) & 0b11) - 1;
}

/** Bits 3, 4 and 5 (counting from MSB), minus 1. */
export function getBit3and4and5(frame: Uint8Array, offset: number): number {
  return ((frame[offset]! >> 3) & 0b111) - 1;
}

/** Bits 5 and 6 (counting from MSB), minus 1. */
export function getBit5and6(frame: Uint8Array, offset: number): number {
  return ((frame[offset]! >> 2) & 0b11) - 1;
}

/** Bottom two bits, minus 1. */
export function getBit7and8(frame: Uint8Array, offset: number): number {
  return (frame[offset]! & 0b11) - 1;
}

/** Bottom three bits, minus 1. */
export function getRight3bits(frame: Uint8Array, offset: number): number {
  return (frame[offset]! & 0b111) - 1;
}

/** Byte value minus 1. */
export function getIntMinus1(frame: Uint8Array, offset: number): number {
  return frame[offset]! - 1;
}

/** Byte value minus 128 (signed temperature offset). */
export function getIntMinus128(frame: Uint8Array, offset: number): number {
  return frame[offset]! - 128;
}

/** (Byte - 1) / 5. HeishaMon rounds to 1 decimal; we return the raw float. */
export function getIntMinus1Div5(frame: Uint8Array, offset: number): number {
  return (frame[offset]! - 1) / 5;
}

/** (Byte - 1) / 50. HeishaMon rounds to 2 decimals; we return the raw float. */
export function getIntMinus1Div50(frame: Uint8Array, offset: number): number {
  return (frame[offset]! - 1) / 50;
}

/** (Byte - 1) * 10. */
export function getIntMinus1Times10(frame: Uint8Array, offset: number): number {
  return (frame[offset]! - 1) * 10;
}

/** (Byte - 1) * 50. */
export function getIntMinus1Times50(frame: Uint8Array, offset: number): number {
  return (frame[offset]! - 1) * 50;
}

/** (Byte - 1) * 200, in watts. */
export function getPower(frame: Uint8Array, offset: number): number {
 ...
 */
export function getOpMode(frame: Uint8Array, offset: number): number {
...
export function getUintt16(frame: Uint8Array, offset: number): number {
  return ((frame[offset + 1]! << 8) | frame[offset]!) - 1;
}

/** High nibble of the byte, minus 1. */
export function getFirstByte(frame: Uint8Array, offset: number): number {
  return (frame[offset]! >> 4) - 1;
}

/** Low nibble of the byte, minus 1. */
export function getSecondByte(frame: Uint8Array, offset: number): number {
  return (frame[offset]! & 0x0f) - 1;
}

/** (Byte - 1) / 2 — three-way valve PID output as percentage. */
export function getValvePID(frame: Uint8Array, offset: number): number {
 ...
 */
export function getPumpFlow(frame: Uint8Array): number {
 ...
 */
export function getOperationsHours(frame: Uint8Array): number {
 ...
 */
export function getOperationsCounter(frame: Uint8Array): number {
 ...
 */
export function getRoomHeaterOperationsHours(frame: Uint8Array): number {
 ...
 */
export function getDhwHeaterOperationsHours(frame: Uint8Array): number {
 ...
 */
export function getErrorInfo(frame: Uint8Array): string {
...
function toUpperHex2(value: number): string {
  if (value < 0) {
 ...
 */
export function getHeatPumpModel(frame: Uint8Array): string {
  const parts: string[] = [];
...
export function getOptZ1WaterPump(frame: Uint8Array): number {
  return (frame[4]! >> 7) & 1;
}

/** Zone 1 mixing-valve request (OPT1). */
export function getOptZ1MixingValve(frame: Uint8Array): number {
  return (frame[4]! >> 5) & 0b11;
}

/** Zone 2 water-pump request (OPT2). */
export function getOptZ2WaterPump(frame: Uint8Array): number {
  return (frame[4]! >> 4) & 1;
}

/** Zone 2 mixing-valve request (OPT3). */
export function getOptZ2MixingValve(frame: Uint8Array): number {
  return (frame[4]! >> 2) & 0b11;
}

/** Pool water-pump request (OPT4). */
export function getOptPoolWaterPump(frame: Uint8Array): number {
  return (frame[4]! >> 1) & 1;
}

/** Solar water-pump request (OPT5). */
export function getOptSolarWaterPump(frame: Uint8Array): number {
  return frame[4]! & 1;
}

/** Alarm state from optional PCB (OPT6). */
export function getOptAlarmState(frame: Uint8Array): number {
  return frame[5]! & 1;
}
