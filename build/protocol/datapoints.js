...
export const MAIN_DATAPOINTS = [
    ...
    { id: 'TOP93', name: 'Pump_Duty', source: 'main', byte: 172, decoder: 'getIntMinus1', writable: false, description: 'Circulation pump duty (raw value 65-254, no physical unit)' },
    { id: 'TOP94', name: 'Zones_State', source: 'main', byte: 6, decoder: 'getBit1and2', writable: true, description: 'Active zones (Z1, Z2, or both)' },
    { id: 'TOP95', name: 'Max_Pump_Duty', source: 'main', byte: 45, decoder: 'getIntMinus1', writable: true, description: 'Maximum circulation pump duty (raw value 65-254, no physical unit)' },
 ...
 */
export const ALL_DATAPOINTS = [
    ...MAIN_DATAPOINTS,
    ...OPTIONAL_DATAPOINTS,
    ...EXTRA_DATAPOINTS,
];
const DATAPOINTS_BY_NAME = new Map(ALL_DATAPOINTS.map((datapoint) => [datapoint.name, datapoint]));
/**
